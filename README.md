...
## ⚙️ 시스템 동작 흐름 (시나리오)
<img width="623" height="164" alt="image" src="https://github.com/user-attachments/assets/3aa2f83a-dd18-44cb-807e-631d68aafafe" />
...
---
■ 결과 및 배운 점
 RFID 인증 기반 보안 제어 시스템을 실환경 수준으로 구현하며, 실시간 제어와 모듈화 아키텍처의 중요성을 확인하였고 RTOS 구조에서의 Task 분리, 메시지 큐 통신 방식 설계 경험을 통해 임베디드 시스템 아키텍처 설계 역량을 강화할 수 있었다. 그리고 하드웨어 제어, 통신, 데이터 관리 기능을 직접 개발하며 시스템 통합 과정 전반에 대한 경험과 문제 해결 능력을 확보할 수 있었다.
